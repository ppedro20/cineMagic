        ...
        <div class="space-y-8">
            ...
            <div>
                ...
                @auth
                    ...
                    <!-- Statistics -->
                    <x-menus.admin-group-menu-items title="Statistics" :options="['Statistics' => route('statistics.index')]">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                ...
                @endauth
                    ...
                    <!-- Only one option -->
                    <x-menus.admin-group-menu-items class="mt-2" title="Return to site" :options="['Home' => route('home')]">
